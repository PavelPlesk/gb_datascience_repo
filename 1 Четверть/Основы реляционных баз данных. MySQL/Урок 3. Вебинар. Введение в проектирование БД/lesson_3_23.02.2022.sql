...
-- Пытаемся добавить профиль для несуществующего пользователя с id 88, получаем ошибку
INSERT INTO profiles VALUES (88, 'm', '1988-11-02', 2, 'Moscow', 'Russia');
...
-- сообщение от Пети к Васе номер 1
