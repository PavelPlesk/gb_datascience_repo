...
CREATE TABLE `equipment` (
  ...
  CONSTRAINT `equipment_ibfk_2` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`)
...
CREATE TABLE `equipment_attributes` (
  ...
  CONSTRAINT `equipment_attributes_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `equipment_categories` (`id`)
...
CREATE TABLE `equipment_values` (
  ...
  CONSTRAINT `equipment_values_ibfk_1` FOREIGN KEY (`equipment_id`) REFERENCES `equipment` (`id`),
  CONSTRAINT `equipment_values_ibfk_2` FOREIGN KEY (`attribute_id`) REFERENCES `equipment_attributes` (`id`)
...
CREATE TABLE `instruments` (
  ...
  `calibration_date` date DEFAULT (curdate()),
  `calibration_validity` date DEFAULT ((`calibration_date` + interval 1 year)),
  UNIQUE KEY `id` (`id`),
...
INSERT INTO `instruments` VALUES (1,'Мегаомметр','E6-31','12345',NULL,'2022-05-07','2023-05-07'),(2,'Мегаомметр','E6-31','245436',NULL,'2022-03-12','2023-03-12'),(3,'Мегаомметр','E6-32','3452124',NULL,'2021-12-14','2022-12-14'),(4,'Аппарат для испытания диэлектриков','АИД-70М','31727',NULL,'2021-12-14','2022-12-14'),(5,'Микроомметр','MIKO-9A','A342',NULL,'2022-01-14','2023-01-14');
...
CREATE TABLE `participants` (
  ...
  UNIQUE KEY `results_id` (`results_id`,`personnel_id`),
  KEY `personnel_id` (`personnel_id`),
  KEY `results_id_2` (`results_id`),
  CONSTRAINT `participants_ibfk_1` FOREIGN KEY (`results_id`) REFERENCES `results` (`id`),
...
CREATE TABLE `report_results` (
  ...
  CONSTRAINT `report_results_ibfk_1` FOREIGN KEY (`report_num`) REFERENCES `reports` (`num`),
...
CREATE TABLE `reports` (
  ...
  `creation_year` year NOT NULL DEFAULT (year(`creation_date`)),
  ...
  CONSTRAINT `reports_chk_1` CHECK ((`creation_year` = year(`creation_date`)))
...
CREATE TABLE `results` (
  ...
  CONSTRAINT `results_ibfk_1` FOREIGN KEY (`equipment_id`) REFERENCES `equipment` (`id`),
...
-- Dump completed on 2022-05-07 16:02:13
